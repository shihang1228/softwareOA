<form id="pagerForm" method="post" action="index.php?action=simzifei">
...
<div class="page">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="?action=simzifei&do=new" target="dialog" mask="true"><span>新增SIM卡资费</span></a></li>
				<li><a class="delete" href="?action=simzifei&do=del&id={id}" target="ajaxTodo"  title="确定要删除吗?"><span>删除SIM卡资费</span></a></li>
			</ul>
		</div>
		<table class="list" layouth="51.5" style="width:400px;">
			<thead>
				<tr align=center>
					...
					<th width="300" align="center">SIM卡资费</th>
				</tr>
			</thead>
			<tbody>			
