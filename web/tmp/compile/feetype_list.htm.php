<form id="pagerForm" method="post" action="index.php?action=feetype">
...
<div class="page">
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="?action=feetype&do=new" target="dialog" mask="true"><span>新增类别</span></a></li>
				<li><a class="delete" href="?action=feetype&do=del&id={id}" target="ajaxTodo"  title="确定要删除吗?"><span>删除类别</span></a></li>
				<li><a class="edit" href="?action=feetype&do=edit&id={id}" target="dialog" mask="true"><span>修改类别</span></a></li>
		...
		<table class="list" layouth="51.5" style="width:400px;">
			<thead>
				<tr align=center>
					...
					<th width="300" align="center">费用类别</th>
				</tr>
			</thead>
			<tbody>			
