<div class="page">
	<div class="pageContent">
		...
		<form method="post" action="?action=shenyan&do=addyun" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
			<div class="pageFormContent" layoutH="56">
				...
				<p>
					<label>运管金额：</label>
					<input name="yunmoney" type="text" size="30" value="" alt=""/>
				</p>
			</div>
			<div class="formBar">
				<ul>
