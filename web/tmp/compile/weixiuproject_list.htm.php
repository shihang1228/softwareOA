<form id="pagerForm" method="post" action="index.php?action=weixiuproject">
...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="index.php?action=weixiuproject" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>
						维修项目:<input type="text" name="name" size="12" value="<?php echo $_REQUEST['name']; ?>"/>
					</td>
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="?action=weixiuproject&do=new" target="dialog" mask="true"><span>新增维修项目</span></a></li>
				<li><a class="delete" href="?action=weixiuproject&do=del&id={id}" target="ajaxTodo"  title="确定要删除吗?"><span>删除维修项目</span></a></li>
				<li><a class="edit" href="?action=weixiuproject&do=edit&id={id}" target="dialog" mask="true"><span>修改维修项目</span></a></li>
		...
		<table class="list" layouth="92" style="width:900px;">
			<thead>
				<tr align=center>
					...
					<th width="200" align="center">价格</th>				
