<form id="pagerForm" method="post" action="index.php?action=jixiao">
...
<div class="page">
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="?action=jixiao&do=new" target="dialog" mask="true"><span>新增评价</span></a></li>
				<li><a class="delete" href="?action=jixiao&do=del&id={id}" target="ajaxTodo"  title="确定要删除吗?"><span>删除评价</span></a></li>
				<li><a class="edit" href="?action=jixiao&do=edit&id={id}" target="dialog" mask="true"><span>修改评价</span></a></li>
				
			</ul>
		</div>
		<table class="list" layouth="51.5" style="width:900px;">
			<thead>
				<tr align=center>
					<th width="100" align="center">ID</th>
					<th width="300" align="center">评价</th>
					<th width="200" align="center">提成</th>
				</tr>
			</thead>
			<tbody>			
