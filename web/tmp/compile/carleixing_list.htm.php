<form id="pagerForm" method="post" action="index.php?action=carleixing">
...
<div class="page">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="?action=carleixing&do=new" target="dialog" mask="true"><span>新增车辆类型</span></a></li>
				<li><a class="delete" href="?action=carleixing&do=del&id={id}" target="ajaxTodo"  title="确定要删除吗?"><span>删除车辆类型</span></a></li>
				<li><a class="edit" href="?action=carleixing&do=edit&id={id}" target="dialog" mask="true"><span>修改车辆类型</span></a></li>
