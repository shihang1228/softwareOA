<form id="pagerForm" method="post" action="index.php?action=caigou&do=search">
...
<div class="pageHeader">
		<form onsubmit="return dwzSearch(this, 'dialog');" action="index.php?action=caigou&do=search" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>
						商品名称:<input type="text" name="name" size="20" value="<?php echo $_REQUEST['name']; ?>"/>
					</td>
					<td>
						型号:<input type="text" name="model" size="20" value="<?php echo $_REQUEST['model']; ?>"/>
					</td>
...
?>
				<tr target="id" rel="<?php echo $this->_var['row']['id']; ?>" align=center>
					...
					<td>
					<a class="btnSelect" href="javascript:$.bringBack({name:'<?php echo $this->_var['row']['name']; ?>',productId:'<?php echo $this->_var['row']['id']; ?>',model:'<?php echo $this->_var['row']['model']; ?>'})" title="查找带回">选择</a>
				</td>
				</tr>			
