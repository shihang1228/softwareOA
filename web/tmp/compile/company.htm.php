<form id="pagerForm" method="post" action="index.php?action=car&do=search">
...
<div class="pageHeader">
		<form onsubmit="return dwzSearch(this, 'dialog');" action="index.php?action=car&do=search" method="post">
		<div class="searchBar">
...
?>
				<tr target="id" rel="<?php echo $this->_var['row']['id']; ?>" align=center>
					...
					<td>
					<a class="btnSelect" href="javascript:$.bringBack({company:'<?php echo $this->_var['row']['company']; ?>'})" title="查找带回">选择</a>
				</td>
				</tr>			
